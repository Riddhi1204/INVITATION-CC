      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          <div className="flex items-center gap-2 mb-6 bg-[#00f0ff]/10 border border-[#00f0ff]/30 px-3 py-1 rounded-sm">
            ...
            <span className="font-mono text-[10px] text-[#00f0ff] uppercase tracking-widest">// SYSTEM INITIALIZED</span>
          </div>

          <h1 className="font-display font-black text-5xl md:text-7xl leading-tight mb-2 tracking-tight">
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400">CODE</span>
          ...
          <div className="text-xl md:text-2xl font-mono text-gray-400 mb-8 tracking-[0.2em]">2026</div>

          <h2 className="font-sans font-bold text-xl md:text-2xl text-white mb-4 tracking-wide">
            THINK. SOLVE. COMPETE.
          </h2>

          <p className="text-gray-400 max-w-md font-sans leading-relaxed mb-10 text-sm md:text-base border-l-2 border-[#b026ff]/50 pl-4">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
            ...
            >
              ...
              <span className="relative z-10 font-bold flex items-center gap-2">
                [ ENTER THE QUEST <span className="group-hover:translate-x-1 transition-transform">→</span> ]
              </span>
            </a>
            
            <div className="flex flex-col font-mono text-xs text-gray-500 uppercase tracking-widest gap-1 border-l border-gray-800 pl-4">
              <span className="text-gray-300">21 SEPTEMBER 2026</span>
